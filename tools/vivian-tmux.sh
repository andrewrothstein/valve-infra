...
if !  tmux list-sessions | grep -q $__vivian_tmux_session ; then
    tmux new-session -d -s $__vivian_tmux_session -n 'Status'
    ...
    tmux new-window -t $__vivian_tmux_session:2 -n 'Gateway Shell'
